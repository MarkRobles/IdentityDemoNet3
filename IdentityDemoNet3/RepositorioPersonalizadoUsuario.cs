...
{
    public class RepositorioPersonalizadoUsuario: UserStoreBase<IdentityUser, string, IdentityUserClaim<string>,
        IdentityUserLogin<string>, IdentityUserToken<string>>
    {
        private readonly IdentityErrorDescriber identityErrorDescriber;

        public RepositorioPersonalizadoUsuario(IdentityErrorDescriber identityErrorDescriber):base(describer: identityErrorDescriber)
        {
