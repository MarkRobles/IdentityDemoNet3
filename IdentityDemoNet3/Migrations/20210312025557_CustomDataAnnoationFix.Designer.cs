...
namespace IdentityDemoNet3.Migrations
{
    ...
    [Migration("20210312025557_CustomDataAnnoationFix")]
    partial class CustomDataAnnoationFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityDemoNet3.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IdentityDemoNet3.Usuario+Organization", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("IdentityDemoNet3.Usuario", b =>
                {
                    b.HasOne("IdentityDemoNet3.Usuario+Organization", null)
                        .WithMany()
                        .HasForeignKey("OrgId");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IdentityDemoNet3.Usuario", null)
                        .WithMany()
